...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="metadata-iso19139.nl.services.1.2.1view-simple">
    <xsl:call-template name="metadata-iso19139view-simple"/>
  </xsl:template>


  <xsl:template name="view-with-header-iso19139.nl.services.1.2.1">
    <xsl:param name="tabs"/>
  ...
  <xsl:template name="metadata-iso19139.nl.services.1.2.1">
  ...
  <xsl:template name="iso19139.nl.services.1.2.1CompleteTab">
