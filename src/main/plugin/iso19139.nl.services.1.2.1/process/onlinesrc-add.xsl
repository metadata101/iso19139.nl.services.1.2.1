  ...
  <xsl:template match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']">
	...
	<xsl:apply-templates
        select="gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:citation|
		 ...
		 gmd:identificationInfo/srv:SV_ServiceIdentification/srv:coupledResource|
		 gmd:identificationInfo/srv:SV_ServiceIdentification/srv:couplingType"/>
            ...
            <srv:SV_OperationMetadata>
               <srv:operationName gco:nilReason="missing">
                  <gco:CharacterString>
				  <xsl:choose>
					<xsl:when test="$protocol='OGC:WMS' or $protocol='OGC:WFS' or $protocol='OGC:WCS' or $protocol='OGC:WMTS' or $protocol='OGC:CSW' or $protocol='OGC:WPS' or $protocol='OGC:SOS'">GetCapabilities</xsl:when>
					<xsl:otherwise>http:get</xsl:otherwise>
				  </xsl:choose>
				  </gco:CharacterString>
               </srv:operationName>
               <srv:DCP>
